...
class ShapeView @JvmOverloads constructor(
    ...
    private val transitions = mapOf(
        Shape.Square to listOf(
            ...
            Transition(Shape.Dash, R.drawable.avd_square_to_dash)
        ),
        Shape.Triangle to listOf(
            ...
            Transition(Shape.Dash, R.drawable.avd_triangle_to_dash)
        ),
        Shape.Hexagon to listOf(
            ...
            Transition(Shape.Dash, R.drawable.avd_hexagon_to_dash)
        ),
        Shape.Rhombus to listOf(
            ...
            Transition(Shape.Dash, R.drawable.avd_rhombus_to_dash)
        ),
        Shape.Dash to listOf(
            Transition(Shape.Square, R.drawable.avd_dash_to_square),
            Transition(Shape.Triangle, R.drawable.avd_dash_to_triangle),
            Transition(Shape.Hexagon, R.drawable.avd_dash_to_hexagon),
            Transition(Shape.Rhombus, R.drawable.avd_dash_to_rhombus)
        )
    )
    ...
    fun updateShape(shape: Shape) {
        if (currentShape == null) {
            ...
            ivShape.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.shape_dash))
